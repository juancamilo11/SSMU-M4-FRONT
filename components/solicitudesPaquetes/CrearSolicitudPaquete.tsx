...
interface CrearSolicitudPaqueteProps {
  setSolicitudesPaquetes: Dispatch<
    SetStateAction<ListaSolicitudesPaquetesResponse>
  >;
}

const CrearSolicitudPaquete = (props: CrearSolicitudPaqueteProps) => {
  const { setSolicitudesPaquetes } = props;
  const {
    register,
    unregister,
    formState: { errors },
  ...
  return (
    <Fragment>
      <div className='m-4 mb-5 overflow-auto p-0'>
        <div className='flex items-center justify-center m-0 p-0'>
          <Header />
          <div className='max-w-md w-full bg-white rounded-lg shadow-lg'>
            <div className='mt-16 px-6 m-0 p-0'>
              ...
              <form>
                ...
                <div className='relative mt-2 mb-2'>
                  <label className='flex cursor-pointer select-none items-center'>
                    <p className='mr-2'>¿Son alimentos o mercado?</p>
          ...
          <div className='max-w-md w-full bg-white rounded-lg shadow-lg'>
            <div className='mt-20 px-6 m-0 p-0'>
              <h1 className='text-2xl font-semibold text-center text-gray-500 mt-4 mb-6'>
                Servicio de envio/recogida de paquete
              </h1>
              <form>
                <div className='mb-4'>
                  <label className='block mb-2 text-sm text-gray-600'>
...
export default CrearSolicitudPaquete;
