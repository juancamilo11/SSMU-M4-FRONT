...
const registerPage = () => {
  ...
  const [errors, setErrors] = useState<Partial<UserRegisterInfo>>({});
  ...
  const handleSubmit = (
    ...
    if (fullName === '') {
      setErrors({ ...errors, fullName: 'El nombre es requerido' });
      return;
    }
    if (phone === '') {
      setErrors({ ...errors, phone: 'El teléfono es requerido' });
      return;
    }
